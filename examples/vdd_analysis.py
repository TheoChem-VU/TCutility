...
def main():
    ...
    vdd_charges = vdd_manager.get_vdd_charges()
    print(vdd_charges)
    ...
    # Also the summed VDD charges can be obtained as a dictionary, which is useful for fragment calculations
    summed_vdd_charges = vdd_manager.get_summed_vdd_charges()

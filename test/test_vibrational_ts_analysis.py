...
def test_validate_sn2_ts_2() -> None:
	...
	assert result == False 	# [2,3,1] should not be present
...
def test_validate_rad_ts_3() -> None:
	...
	assert result == True # Testing user input normalization
...
def test_validate_rad_ts_5() -> None:
	...
	assert result == False # Should not be present with this min_delta_dist parameter value
...
def test_validate_rad_ts_6() -> None:
	...
	assert result == False # Should have equal signs
...
def test_validate_rad_ts_7() -> None:
	...
	assert result == False # Sign has to be provided for all reaction coordinates or none of them
